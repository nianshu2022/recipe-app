...
export function FridgePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Add modal */}
      {showAdd && (
        <div className="fixed inset-0 z-50 flex items-end justify-center" onClick={() => { setShowAdd(false); setNewName(''); setNewBrand(''); setNewAmount(''); setNewUnit(''); setNewExpiryDays(''); setNewPurchaseDate(new Date().toISOString().split('T')[0]); setNewNutriments(undefined); setOffResults([]); setOffError(null); setHasSearched(false) }}>
