...
const sampleRecipes: Omit<Recipe, 'id' | 'syncStatus' | 'createdAt' | 'updatedAt'>[] = [
  {
    ...
    steps: [
      ...
      { order: 4, description: '加入糖和盐调味，倒回炒好的鸡蛋翻炒均匀，尝一下调整咸淡', tip: '番茄偏酸可以多加点糖，喜欢汤汁多的可以少收一会儿', timer: 1 },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: generateId(), name: '花椒粉', amount: 1, unit: '茶匙', type: 'seasoning', scalable: false },
    ...
    steps: [
      ...
      { order: 4, description: '加入约100ml清水（小半碗）烧开，放入豆腐块，轻轻推动，小火炖煮入味', timer: 5 },
